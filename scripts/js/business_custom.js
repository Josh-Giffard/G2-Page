jQuery('form').on('submit', function(e){
  ...
  jQuery(document).ready(function(){
    console.log("Document is ready"); // Debug: Log when document is ready
  
    jQuery('#calculate_quote_count').click(function() {
      console.log("Calculate quote button clicked"); // Debug: Log when button is clicked
      ...
      console.log("Values:", business_turnover, business_employees, business_software, growthplans); // Debug: Log the values
      ...
      jQuery.post({
        ...
        data: {
          ...
          action: "business_calulator"
        },
        success: function(data) {
          console.log("AJAX Response:", data); // Debug: Log the AJAX response
  
          var JSONObject = JSON.parse(data);
          console.log("Parsed JSON:", JSONObject); // Debug: Log the parsed JSON object
